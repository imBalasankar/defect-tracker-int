      ...
      <form className={classes.container} autoComplete="off">
        <Grid container direction="column">
          <table>
            ...
            <tr>
              <td>Module</td>
              <td>{defect.moduleId}</td>
            </tr>
            <Divider />
            <tr>
              <td>Sub Module</td>
              <td>{defect.submoduleId}</td>
            </tr>
            <Divider />
            <tr>
              <td>Defect Type</td>
            ...
            <tr>
              ...
              <td>{defect.priorityId}</td>
            </tr>
            <Divider />
            <tr>
              <td>Defect Severity</td>
              <td>{defect.severityId}</td>
            </tr>
            <Divider />
            <tr>
              <td>Assigned To</td>
